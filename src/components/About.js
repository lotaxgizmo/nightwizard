    ...
    return (
        <div className='flex flex-col items-center justify-center relative px-4 py-52'>
            ...
            <div className="rounded-3xl overflow-clip px-4 pt-10  lg:p-10 text-white bg-[#286566] relative flex flex-col justify-center items-center lg:w-7/12 border-2 border-black">
                ...
                <p className='z-50 text-xl lg:text-4xl my-10 gill text-center font-bold'>In Matt Furie's The Night Riders, the wizard character is a notable figure within the surreal and whimsical world of the story. This character is often depicted as a ghostly figure with a flowing robe and a large, pointed wizard's hat. The wizard appears during the nocturnal adventures of the frog and rat duo, contributing to the magical and mysterious ambiance of their journey through forests and other eerie landscapes.
